import { ObjectPaths, StringBreakByDelimiter } from '@properly-typed/utils';

type ObjectByPath<
  PATH extends string,
  DELIMITER extends string,
> = StringBreakByDelimiter<PATH, DELIMITER> extends [infer START, infer REST]
...
export type ObjectWithProperty<
  ...
  PATH extends string,
  DELIMITER extends string,
> = PATH extends ObjectPaths<TARGET, DELIMITER>
  ? TARGET
